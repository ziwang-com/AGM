...
而这些最前沿的课题，居然都在采用最原始的GPU暴力运算，这本身就是一种自我矛盾、值得研究的的课题。
为此，我们参见提出了：logNET基于逻辑的AI神经网络模型，并且有成功的工程案例，效率比AI神经网络模型高10万倍以上。
无独有偶，近年，深度学习教父Geoffrey Hinton，提出的“胶囊理论”，也是类似观点。
近日，wm提出的zeto-lora算法模型，以及刚刚发表的论文《TOT思维树》，都可以：
